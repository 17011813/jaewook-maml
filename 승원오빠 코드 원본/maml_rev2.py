...
class MAML:
    ...
    def construct_model(self, input_tensors=None, prefix='metatrain_'):
        ...
        with tf.variable_scope('model', reuse=None) as training_scope:
            ...
            num_updates = max(self.test_num_updates, FLAGS.num_updates)  # 현재 5로 설정..
            ...
            def task_metalearn(inp, reuse=True):
                ...
                # if FLAGS.stop_grad: # stop_grad가 False여서 일단 주석처리
                ...
                for j in range(num_updates - 1):  # 5번
            ...
            def task_metatest(inp, reuse=True):
                ...
                task_output = [task_outputa,  task_lossa]
                return task_output
            ...
            out_dtype_test = [tf.float32,  tf.float32]
        ...
        if 'metatrain_' in prefix:
            ...
            optimizer_a = tf.train.AdamOptimizer(self.meta_lr)
            self.pretrain_op = optimizer_a.minimize(self.total_loss1)
            self.gra_a = optimizer_a.compute_gradients(self.total_loss1)
            ...
            print('Meta TEST!!!!!!!!!!!!!')
            result_test = tf.map_fn(task_metatest, elems=(self.inputa, self.labela),
                                    dtype=out_dtype_test, parallel_iterations=FLAGS.meta_batch_size)
            outputas, lossesa = result_test
